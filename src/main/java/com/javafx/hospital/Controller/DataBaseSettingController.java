...
public class DataBaseSettingController implements Initializable {
    ...
    public void validar() throws IOException {
        ...
        if (DBUser.getText().isEmpty() || DBPassword.getText().isEmpty() || DBUrl.getText().isEmpty()) {
            alertMessage.errorMessage("Campos Vazios devem ser preenchidos");
        } else if (alertMessage.confirmMessage(DBUrl.getText() + "," + DBUser.getText() + "," + DBPassword.getText())) {
